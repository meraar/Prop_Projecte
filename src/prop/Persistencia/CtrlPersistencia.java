...
public class CtrlPersistencia {
     ...
     * @throws Exception Errors de lectura
     */
    public void escriureBinari(ArrayList<Serializable> objectes, String pathFitxer) throws Exception {
        // Afegim l'extensió si no està afegida correctament
        if (!pathFitxer.endsWith(".prop")) {
            pathFitxer += ".prop";
        }

        FileOutputStream file = new FileOutputStream(pathFitxer);
