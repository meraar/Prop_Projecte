...
public class Driver_AtributBool extends AbstractDriver {
        ...
        switch (opcion) {
            case 1:
                try {
                    ...
                    AtributBool atrBoolNT = new AtributBool(nom1, tipuss1);
                    String nomA1 = atrBoolNT.getNom();
                    Tipus tipusA1 = atrBoolNT.getTipus();
            ...
            case 2:
                try {
                    ...
                    Tipus tipuss2 = Tipus.valueOf(tipus2);
                    AtributBool atrBoolVal = new AtributBool(nom2, tipuss2, valorF2, valorT2);
                    String nomA2 = atrBoolVal.getNom();
                    Tipus tipusA2 = atrBoolVal.getTipus();
    ...
    public static void testGetNom(){
        try {
            String nom1 = llegeixString("Indiqui el nom de l'atributBool a crear:");
            AtributBool atr = new AtributBool(nom1, Tipus.BOOL);
    ...
    public static void testGetTipus() {
        try {
            ...
            AtributBool atr = new AtributBool("atri", Tipus.BOOL);
    ...
    public static void testSetNom() {
        ...
        try {
            ...
            AtributBool atr = new AtributBool("a1",Tipus.BOOL);
            atr.setNom(nom1);
            System.out.println("El nom de l'atribut introduit es: "+ nom1 + " i el nom de l'atribut es: "+ atr.getNom());
        }
        catch (Exception e) {
    ...
    public static void testValidarValor() {
        ...
        try {
            AtributBool atr = new AtributBool("atr", Tipus.BOOL, "false", "cierto");
    ...
    public static void testProcessar() {
        ...
        try {
            AtributBool atr = new AtributBool("atr", Tipus.BOOL);
    ...
    public static void testSetValorsB() {
        ...
        try {
            ...
            AtributBool atB = new AtributBool("atributBool",Tipus.BOOL);
            ...
            valors.add(0,valorF);
            valors.add(1,valorT);
            AtributBool atBDef = new AtributBool("atributBool",Tipus.BOOL,valors.get(0),valors.get(1));
    ...
    public static void testGetValorsB() {
        ...
        try {
            ...
            AtributBool atB = new AtributBool("atributBool",Tipus.BOOL,valorF,valorT);
