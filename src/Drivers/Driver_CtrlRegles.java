...
public class Driver_CtrlRegles extends AbstractDriver {
    ...
    private static void testConstructora(){
        ...
        Regles = new CtrlRegles(new CtrlPersistencia(), new CtrlDomini());
    }
    ...
    private static void testApriori(){
       /* System.out.println(" Test Apriori  i generar regles");
        ...
        try {
            HashMap<Integer, HashMap<Float, Float>> regles_generades = Regles.apriori(minSuport, minConfianza, nRegles);
            generatRegles = true;
    ...
    private static void testvalidarRegles(){
       /* if(generatRegles) {
            ...
            try {
                Regles.validarRegles(minSup, minConf);
                //imprimir_Map(val);
            } catch (Exception e) {
                imprimeixError(e);
            }
    ...
    public  static  void main (String[] args){
        ...
        CtrlDomini domini = new CtrlDomini();
