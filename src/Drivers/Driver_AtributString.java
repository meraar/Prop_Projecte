...
public class Driver_AtributString extends AbstractDriver{
        ...
        switch (opcion) {
            ...
            case 1:
                try {
                    ...
                    AtributString atrStringNT = new AtributString(nom1, tipuss1);
                    String nomA1 = atrStringNT.getNom();
                    Tipus tipusA1 = atrStringNT.getTipus();
            ...
            case 2:
                ...
                AtributString atrStringNTV = new AtributString(nom2, tipuss2, valors);
                String nomA2 = atrStringNTV.getNom();
                Tipus tipusA2 = atrStringNTV.getTipus();
    ...
    public static void testGetNom() {
        try {
            String nom1 = llegeixString("Indiqui el nom de l'atributString a crear:");
            AtributString atr = new AtributString(nom1, Tipus.STRING);
    ...
    public static void testGetTipus() {
        try {
            ...
            AtributString atr = new AtributString("atri", Tipus.STRING);
    ...
    public static void testValidarValor() {
        ...
        AtributString atr = new AtributString("atr", Tipus.STRING);
        HashSet<String> valors = new HashSet<>();
        valors.add("Sa");
        valors.add("Malalt");
