...
public class Driver_CtrlRegistres extends AbstractDriver {
    ...
    private static CjtAtributs cjtAtributsProva() throws Exception {
        ...
        AtributString atr1 = new AtributString("Nom", Tipus.STRING);
        ...
        AtributInt atr2 = new AtributInt("NotaParcial1", Tipus.FLOAT);
        intervalsNotes(atr2);
        atributs.add(atr2);

        AtributBool atr3 = new AtributBool("EntregaTreb", Tipus.BOOL, "No", "Si");
        atributs.add(atr3);

        AtributInt atr4 = new AtributInt("NotaFinal", Tipus.FLOAT);
        intervalsNotes(atr4);
        atributs.add(atr4);
    ...
    private static void intervalsNotes(AtributInt atribut) throws Exception {
