...
public class AtributString extends Atribut {
     ...
     */
    public AtributString(String nom, String tipus) throws Exception {
        super(nom);
        ValorsPos = new HashSet<>();
        if(tipus.equals("String"))this.tipus=tipus;
     ...
     * @throws Exception Error de tipus
     */
    public AtributString(String nom, String tipus, HashSet<String> ValosPos) throws Exception {
        super(nom);
        ValorsPos = new HashSet<>();
        if(tipus.equals("String"))this.tipus=tipus;
        else throw new Exception("Tipus d'atribut invalid");
