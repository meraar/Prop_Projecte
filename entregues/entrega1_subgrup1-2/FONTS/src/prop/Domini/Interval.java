...
public class Interval {
     ...
     */
    public Interval(float lim_superior, float lim_inferior, boolean igual_superior, boolean igual_inferior, String nom){
        if(lim_inferior<lim_superior) {
            ...
            this.igual_superior = igual_inferior;
            this.igual_inferior = igual_superior;
            this.nom = nom;
