...
public class AtributBool extends Atribut {
     ...
     */
    public AtributBool(String nom, String tipus) throws Exception{
            super(nom);
     ...
     * @throws Exception Error de tipus
     */
    public AtributBool(String nom, String tipus, String ValorFalse, String ValorTrue) throws Exception {
        super(nom);
        if(tipus.equals("boolean"))this.tipus=tipus;
        else throw new Exception("Tipus d'atribut invalid");
