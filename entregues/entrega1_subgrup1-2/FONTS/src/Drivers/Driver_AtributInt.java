...
public class Driver_AtributInt extends AbstractDriver{
    ...
    public static void testConstructor() {
        System.out.println("*Constructora amb nom i tipus");
                try {
                    ...
                    AtributInt atrIntNT = new AtributInt(nom1, tipus1);
                    String nomA1 = atrIntNT.getNom();
                    String tipusA1 = atrIntNT.getTipus();
    ...
    public static void testGetNom() {
        try {
            ...
            AtributInt atr = new AtributInt(nom1, "float");
    ...
    public static void testGetTipus() {
        try {
            ...
            AtributInt atr = new AtributInt("atri", "float");
    ...
    public static void testSetNom() {
        try {
            ...
            AtributInt atr = new AtributInt("nomCreadora","float");
            atr.setNom(nom1);
            System.out.println("El nom de l'atribut introduit es: " + nom1 + " i el nom de l'atribut es:" + atr.getNom());
    ...
    public static void testAfegirInterval() {
        try {
            ...
            System.out.println("L'interval afegit te per nom, limit inferior, limit superior, interval tancat per sobre i interval tancat per sota: " +atr.getLlistaInterval().get(0).getNom()+ " " +atr.getLlistaInterval().get(0).getLimSup() + " "+atr.getLlistaInterval().get(0).getLimInf() + " "+atr.getLlistaInterval().get(0).getIgualSup()+ " "+atr.getLlistaInterval().get(0).getIgualInf() );
        }catch (Exception e) {
            imprimeixError(e);
        }
    }
    public static void testAfegirLlistaInterval() {
        try {
            ...
            System.out.println("Els intervals afegits son: "+atr.getLlistaInterval().get(0).getNom() + " i tambe " + atr.getLlistaInterval().get(1).getNom());
        }catch (Exception e) {
            imprimeixError(e);
        }
    }
    public static void testGetLlistaInterval(){
        try {
            ...
            System.out.println("El primer interval afegit te per nom, limit inferior, limit superior, interval tancat per sobre i interval tancat per sota: " + atr.getLlistaInterval().get(0).getNom() + " " + atr.getLlistaInterval().get(0).getLimSup() + " " + atr.getLlistaInterval().get(0).getLimInf() + " " + atr.getLlistaInterval().get(0).getIgualSup() + " " + atr.getLlistaInterval().get(0).getIgualInf());
            System.out.println("El segon interval afegit te per nom, limit inferior, limit superior, interval tancat per sobre i interval tancat per sota: " + atr.getLlistaInterval().get(1).getNom() + " " + atr.getLlistaInterval().get(1).getLimSup() + " " + atr.getLlistaInterval().get(1).getLimInf() + " " + atr.getLlistaInterval().get(1).getIgualSup() + " " + atr.getLlistaInterval().get(1).getIgualInf());
